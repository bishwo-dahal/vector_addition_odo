...
void vec_add_on_gpu(int rank, int hwthread, char *name, double *sub_a, double *sub_b, double *sub_c, size_t sub_buffer_size, long long int chunk){
    ...
    printf("MPI %02d - HWT %03d - GPU %d (BUS ID %s) - Node %s\n", rank, hwthread, gpu_id, bus_id, name);
    fflush(stdout);
